$(document).ready(function() {
    ...
    function addDeduction() {
                var html = `<li class="list-group-item" id="deduction_${counter_deduction}">
                        <div class="row">   
                            <div class="col">
                            ...
                            <div class="col-auto">
                                <button type="button" id="deleteDeduction_${counter_deduction}" class="form-control btn btn-danger remove" >
