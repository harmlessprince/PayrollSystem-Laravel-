...
<div class="row align-items-center">
    ...
    <div class="col-md-2 form-group align-items-end">
        <button type="button" class="btn btn-primary mt-4" name="" id="generate_payslip"  data-toggle="modal" data-target=".bd-example-modal-lg">Generate
            Payslip</button>
    </div>
                                ...
                                <ul class="list-group allowance_container" id="allowance_list">
                                    <li class="list-group-item">
                                        <div class="row allowance_form">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <input type="number" class="form-control" name="" id="allowance_value">
                                                </div>
                                            </div>
                                            <div class="col-auto">
                                ...
                                <ul class="list-group deduction_container" id="deduction_list">
                                    <li class="list-group-item">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <input type="number" class="form-control" name="" id="deduction_value">
                                                </div>
                                            </div>
                                            <div class="col-auto">
