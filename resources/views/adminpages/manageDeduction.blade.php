...
@section('page-name', 'Manage Deductions')
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$index+1}}</td>
                        <td  class="text-capitalize">{{$deduction->deduction_name}}</td>
                        <td>
                            <a href="/allowance/edit/{{$deduction->id}}" class="btn btn-sm btn-primary" role="button">Edit</a>
